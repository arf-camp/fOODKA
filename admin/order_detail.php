...
//for adding some wallet money to referal user if new user deliver 1 item 
                  ...
                  <div class="card-body">
                    ...
                    <div class="container-fluid d-flex justify-content-between">
                      <div class="col-lg-3 pl-0">
                        <p class="mt-5 mb-2"><b>FOODKA</b></p>
                        <p>Shop Address:212/KHILGAON, DHAKA</p>
                      </div>
                      <div class="col-lg-3 pr-0">
                        ...
                        <p class="text-right">
							...
							Zipcode:<?php  echo $orderRow['zipcode']?><br/>
