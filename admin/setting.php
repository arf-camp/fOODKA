                ...
                <div class="card-body">
                  <form class="forms-sample" method="post">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Cart min price" name="cart_min_price"  value="<?php echo $cart_min_price?>">
                    </div>
                    <div class="form-group">
...
<div class="form-group">
                      ...
                      <input type="textbox" class="form-control" placeholder="Refferal Amount" name="referral_amt"  value="<?php echo $referral_amt?>">
                    </div>
