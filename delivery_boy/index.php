   ...
   <body class="sidebar-light">
      <div class="container-scroller">
            ...
            <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
               <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                  <a class="navbar-brand brand-logo" href="index.php">
                    ...
                    <img src="../admin/assets/images/foodka200_90.jpg" alt="FoodKa logo">
                  </a>
         ...
         <div class="container-fluid page-body-wrapper">
                  ...
                  <div class="card">
                     <div class="card-body">
                        <h1 class="grid_title">Order Master</h1>
                          <h7 class="grid_title">Profile Name:<?php echo $_SESSION['DELIVERY_BOY_USER'] ?></h7>
                                 ...
                                 <table id="order-listing" class="table">
                                    <thead>
                                       <tr>
                                          ...
                                          <th width="20%">Customer name/Mobile</th>
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                         ...
                                         <!-- <td style="font-size:14px;"><?php // echo $row['final_price']?></td> -->

                         <td style="font-size:15px;"><?php echo $row['total_price']?><br/>
                        <?php
                        if($row['coupon_code']!=''){
                        ?>(After coupon applied)<br/>Final Price:
            ...
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <?php echo date('Y') ?><a href="https://arf-camp.github.io/portfolio/" target="_blank"> ARF_CAMP</a>. All rights reserved.</span>
          </div>
               </footer>
               <!-- partial -->
            </div>
